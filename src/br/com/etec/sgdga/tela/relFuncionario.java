...
public class relFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Relatorio de Funcionario");
...
private void gerarRelatorio1() throws SQLException, JRException {
        try {
            ...
            JasperPrint print;
            print = JasperFillManager.fillReport("Relatorio/Funcionario.jasper", filtro, ControlaConexao.getControlaConexao());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(relFuncionario.class.getName()).log(Level.SEVERE, null, ex);
        }
